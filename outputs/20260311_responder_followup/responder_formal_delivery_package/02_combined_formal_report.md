# Responder 正式报告包（基线主结果 + school split follow-up）

> 本页是正式报告的总入口，按“正式主结果 → grouped split follow-up → out-phase temporal validation → protocol 与写作边界”的顺序组织，适合发送给协作方或项目接收方。
...
> 如果只需要一句话：这套包的核心价值，不是把分数做高，而是把“正式主结果 + grouped split + out-phase + protocol 边界”串成一条能防守的解释链。
...
- 总览页： [02_combined_formal_report.html](02_combined_formal_report.html)
- follow-up 正式说明页： [01_followup_formal_report.html](01_followup_formal_report.html)
