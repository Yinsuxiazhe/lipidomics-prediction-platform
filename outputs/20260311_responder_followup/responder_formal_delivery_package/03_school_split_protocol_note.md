# 学校 / 社区 split 与运动 protocol 说明

> 本页基于两篇参考文献与当前项目已完成分析整理，目的不是重写正式主结果，而是把“学校 / 社区 split 放在哪里、能怎么写、不能怎么写、运动 protocol 如何稳妥落地”整理成可直接引用的正式说明。
...
- 如果把 02 页看成“总览页”，那这页就是用于补充方法学解释与写作边界的正式说明页。
...
4. `02_combined_formal_report.html`：汇总当前结论边界、页面入口与正式说明顺序。
