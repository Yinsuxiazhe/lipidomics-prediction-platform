# Responder follow-up 结果说明（school split + out-phase）

> 本页用于正式结果说明：在不改变 strict nested CV 主结果的前提下，补充真实 school grouped split 与 out-phase internal temporal validation 的结果解释、边界说明与引用路径。
...
- school split 与 protocol 说明：`03_school_split_protocol_note.html`
...
- 它说明：这不是单次切分偶然得到的结果，但它也没有显示出强泛化。
...
- 学校 split / protocol 说明： [03_school_split_protocol_note.html](03_school_split_protocol_note.html)
